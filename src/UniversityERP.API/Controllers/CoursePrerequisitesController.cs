...
public class CoursePrerequisitesController : ControllerBase
{
    ...
    public CoursePrerequisitesController(ICoursePrerequisiteService service)
    {
        _service = service;
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CoursePrerequisiteCreateDto dto)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] CoursePrerequisiteUpdateDto dto)
    {
        dto.Id = id;
