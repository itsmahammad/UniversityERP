...
public class CourseOfferingsController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CourseOfferingCreateDto dto)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] CourseOfferingUpdateDto dto)
    {
        dto.Id = id;
