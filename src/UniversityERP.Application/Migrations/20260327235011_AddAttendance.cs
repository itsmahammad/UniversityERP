    ...
    public partial class AddAttendance : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_EnrollmentCourses_EnrollmentCourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_AttendanceSessionId_EnrollmentCourseId",
                table: "AttendanceRecords",
                columns: new[] { "AttendanceSessionId", "EnrollmentCourseId" },
                unique: true,
                filter: "\"IsDeleted\" = false");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_EnrollmentCourseId",
                table: "AttendanceRecords",
                column: "EnrollmentCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_CourseOfferingId_SessionDate",
                table: "AttendanceSessions",
                columns: new[] { "CourseOfferingId", "SessionDate" },
                unique: true,
                filter: "\"IsDeleted\" = false");
        }
